        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Bringing you the finest handcrafted pastries, baked fresh every day with love and the highest quality ingredients.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-muted-foreground">+234 706 137 1437</span>
              </li>
              <li className="flex items-start space-x-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-muted-foreground">8 Onitsha Crescent Independence Layout, Enugu, Nigeria</span>
              </li>
            </ul>
          </div>
